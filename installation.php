  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Copart Analytics</a>
        </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="installation.php">InstallationInfo Report</a></li>
      ...
      ?>         
          ...
          <h2 class="sub-header">Installation Report - Count : 
